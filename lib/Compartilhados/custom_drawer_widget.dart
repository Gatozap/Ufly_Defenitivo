         ...
         height: getAltura(context),
          child: SingleChildScrollView(
            ...
            children: <Widget>[
              Text(
                'Equipe uFly',
                style: TextStyle(fontFamily: 'malgun', fontSize: 17, color: Colors.black, fontWeight: FontWeight.bold),
              ),
            ],
          ),
                ...
                Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[hTextAbel('5,0', context),sb, Container(child: Image.asset('assets/estrela.png'),)])
            ,    
             ...
             Divider()
               , sb,
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(width: 40,child: Image.asset('assets/home.png'),),
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(width: 40,child: Image.asset('assets/map.png'),), menuButton(context, 'Suas Viagens',  true, () {
                        Navigator.of(context).push(MaterialPageRoute(
               ...
               Padding(
                 ...
                 child: Row(
                   children: <Widget>[
                     Container(width: 40,child: Image.asset('assets/dirija.png'),), menuButton(context, 'Dirija na Ufly',  true, () {
                       /* Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
               ...
               Padding(
                 ...
                 child: Row(
                   children: <Widget>[
                     Container(width: 40, child: Image.asset('assets/ajuda.png'),),  menuButton(context, 'Ajuda',  true, () {
                        Navigator.of(context).push(MaterialPageRoute(
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(width: 40,child: Image.asset('assets/configuracao.png'),), menuButton(context, 'Configurações',  true, () {
                ...
                Padding(
                  padding:  EdgeInsets.only(top: getLargura(context)*.45, left: 10 ),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      
                      Container(width: 40,child: Image.asset('assets/sair.png'),)
                    ,menuButton(context, 'Sair',  true, () {

                })

                      ,hTextAbel('v0.000.000.1', context),
                 ] ),
                ),
        ...
        child: MaterialButton(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Container(
                  child: Expanded(
                child: hTextAbel(text, context, size: size == null? 60: size)
              ))
