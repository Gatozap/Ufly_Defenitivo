                ...
                child: Center(
                  child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border(
                            top:
                                BorderSide(color: Colors.indigo[50], width: 1)),
                      ),
                      child: Column(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Container(
                                ...
                                child: Center(
                                    child: hTextAbel('CONTINUAR', context,
                                        size: 31))),
                          ),
                        ],
                      )),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                  padding: EdgeInsets.only(
                      top: ResponsivePixelHandler.toPixel(20, context)),
                  child: hTextMal('Cadastro de Email', context,
                      size: 25, weight: FontWeight.bold)),
              sb,
              Center(
                child: Container(
