...
class Carro{
  ...
  String nome_motorista;
   Carro.Empty();
  Carro({this.foto, this.modelo, this.created_at, this.isMoto,this.id_usuario, this.foto_documento,this.deleted_at, this.updated_at,this.placa, this.ano,this.categoria, this.id, this.id_motorista, this.nome_motorista, this.cor});

  @override
  String toString() {

    return 'Carro{foto: $foto, modelo: $modelo,created_at: $created_at,foto_documento: $foto_documento,isMoto:$isMoto,id_usuario:$id_usuario, deleted_at: $deleted_at, updated_at: $updated_at, categoria: $categoria,ano: $ano, placa: $placa, cor: $cor,id:$id, id_motorista: $id_motorista, nome_motorista: $nome_motorista}';
  ...
  this.isMoto = json['isMoto'] == null? false : json['isMoto'],
