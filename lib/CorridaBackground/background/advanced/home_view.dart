...
class HomeViewState extends State<HomeView> with TickerProviderStateMixin<HomeView>, WidgetsBindingObserver {
  ...
  void _configureBackgroundGeolocation(orgname, username) async {
    ...
    print("AQUI FAZENDO SETUP CAPETA");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title:  hText('Autooh',context,color:corPrimaria),
          centerTitle: true,
          leading: IconButton(onPressed: _onClickHome, icon: Icon(Icons.arrow_back, color: corPrimaria)),
          ...
          bottom: TabBar(
              ...
              tabs: [
                Tab(icon: Icon(Icons.map,color:corPrimaria)),
                Tab(icon: Icon(Icons.list,color:corPrimaria))
              ]
          )
      ),
      //body: body,
